...
add_files -tb ../src/tb_control_data_driven_df.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb ../src/control_data_driven_df.hpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"

add_files ../src/control_data_driven_df.cpp
add_files ../src/control_data_driven_df.hpp

set_top control_data_driven_df
