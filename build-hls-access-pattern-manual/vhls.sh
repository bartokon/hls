...
add_files -tb ../src/tb_access_pattern_manual.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb ../src/access_pattern_manual.hpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"

add_files ../src/access_pattern_manual.cpp
add_files ../src/access_pattern_manual.hpp

set_top access_pattern_manual
