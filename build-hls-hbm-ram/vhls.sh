...
add_files -tb ../src/tb_hbm_ram.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb ../src/hbm_ram.hpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"

add_files ../src/hbm_ram.cpp
add_files ../src/hbm_ram.hpp
