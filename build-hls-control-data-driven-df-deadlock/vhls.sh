...
add_files -tb ../src/tb_control_data_driven_df_deadlock.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
add_files -tb ../src/control_data_driven_df_deadlock.hpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"

add_files ../src/control_data_driven_df_deadlock.cpp
add_files ../src/control_data_driven_df_deadlock.hpp

set_top control_data_driven_df_deadlock
